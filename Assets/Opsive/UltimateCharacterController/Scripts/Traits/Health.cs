...
namespace Opsive.UltimateCharacterController.Traits
{
    ...
    public class Health : StateBehavior
    {
        ...
        /// <summary>
        /// Returns true if the object can take damage.
        /// </summary>
        /// <param name="amount">The amount of damage to apply.</param>
        /// <returns>True if the object can take damage.</returns>
        public bool CanDamage(float amount)
        {
            return !(m_Invincible || !IsAlive() || m_SpawnTime + m_TimeInvincibleAfterSpawn > Time.time || amount == 0);
        }
