...
namespace Opsive.UltimateCharacterController.ThirdPersonController.Camera.ViewTypes
{
    ...
    public abstract class ThirdPerson : ViewType
    {
        ...
        [Tooltip("The lerping speed when determining the align to ground character rotation.")]
        [SerializeField] protected float m_AlignToGroundRotationSpeed = 0.8f;
        ...
        public float AlignToGroundRotationSpeed { get { return m_AlignToGroundRotationSpeed; } set { m_AlignToGroundRotationSpeed = value; } }
        ...
        public override Quaternion Rotate(float horizontalMovement, float verticalMovement, bool immediateUpdate)
        {
            ...
            if (m_CharacterLocomotion.AlignToGravity) {
                ...
                m_CharacterRotation = Quaternion.Slerp(m_CharacterRotation, MathUtility.TransformQuaternion(m_CharacterTransform.rotation, Quaternion.Euler(localRotation)), m_AlignToGroundRotationSpeed);
            }
