...
namespace Opsive.UltimateCharacterController.Editor.Inspectors.Character
{
    ...
    public class UltimateCharacterLocomotionInspector : StateBehaviorInspector
    {
        ...
        private void UpdateDefaultMovementTypes()
        {
            ...
            if (!string.IsNullOrEmpty(m_CharacterLocomotion.FirstPersonMovementTypeFullName) && UnityEngineUtility.GetType(m_CharacterLocomotion.FirstPersonMovementTypeFullName) == null) {
                m_CharacterLocomotion.FirstPersonMovementTypeFullName = string.Empty;
                InspectorUtility.SetDirty(target);
            }
            if (!string.IsNullOrEmpty(m_CharacterLocomotion.ThirdPersonMovementTypeFullName) && UnityEngineUtility.GetType(m_CharacterLocomotion.ThirdPersonMovementTypeFullName) == null) {
